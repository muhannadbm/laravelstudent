...
/*SC_GROUP_JS*/
	try {
		(function($)
		{
			$(document).ready(function()
			{
				window.ytf_249=new YTF({"existing":[],"key":"AIzaSyBpY-8w07dI-Ky_dY0K96aDwZt2O4dPjA0","lang":{"RECENT":"Recent","MINUTE":"minute","HOURS":"hours","DAYS":"days","MONTHS":"months","YEARS":"years","AGO":"ago","BY":"By","SHOW_LIST":"Show list","HIDE_LIST":"Hide list","PLAYING":"\u0130zliyorsunuz...","SEE_DESC":"See description","VIEWS":"views"},"data":[{"method":"video","videos":["YJgklGbhHgo","YlBfplpocyc","r7s1E_KjBeU","KwI8cmKnRN8","v8V82K54KBg","WaN81OtG9Ks","tJ_jef0-sBc","SgGxha0bmRQ","bP4h-3O27HY","snS_dlcT2J4","UMbfe4zQHUU","QgkTUF2AKmk","VMb_BkEVueQ","JCknH55w1w0","BkmwatoreDw","_fs4HS_yN24","yLPEfvRtNHc","Nnn4uG7UBMs","QlN_cWf32oY","AtOblkpr5QI","x6LneOHAdho","8bswPFqeqD4","AnkvO3_HKF4","db_51KameKU","idk-oufB400"]}],"style":"grid","moduleid":"249","autoplay":false,"autonext":true,"controls":true,"showinfo":true,"theme":"dark","rel":false,"quality":"default","random":false,"maxword":10,"thumbsize":"mqdefault.jpg","show_duration":true,"show_author":true,"show_created":false,"ratio":"16:9","show_list":true,"fs":true,"small_devices":320,"medium_devices":540,"large_devices":750,"annotation":true,"loop":false,"brand":false,"popup":false,"popup_trigger":false,"limit":20,"listcenter":true,"show_desc":true,"root":"https:\/\/www.sonaxmerkezservis.com\/","intromode":false,"bgurl":false,"introtext":null,"background_tool":true,"grid_popup":false,"showthumb":true,"searchbox":false,"rc_sort":"none","show_views_count":"0"});
			})
		})(jQuery);
	} catch(err) {
