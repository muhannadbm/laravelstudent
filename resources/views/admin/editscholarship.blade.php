...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{url('/')}}/admin/schoalrship"><i class="fa fa-dashboard"></i>Scholarship List</a></li>
    ...
    <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form  action="{{url('/')}}/admin/scholarship/update/{{$data[0]->Id}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
                ...
                <div class="form-group">
                    <label >Details</label>
                    <input type="text" name="detail" value="{{$data[0]->description}}" class="form-control" id="desc" placeholder="details">
                </div>
                <!-- <div class="form-group">
                     <label >Keywords</label>
                ...
                <div class="form-group">
                    <label>Type</label>
                    <input type="text" name="typee" value="{{$data[0]->typee}}" class="form-control" id="" placeholder="Type">
                ...
                <div class="form-group">
                    <label >Date</label>
                    <input type="date" name="date" value="{{$data[0]->date}}" class="form-control" id="" placeholder="date">
                </div>
        ...
        <a href="{{url('/')}}/admin/scholarship"><button  class="btn btn-primary" >Cancel</button></a>
