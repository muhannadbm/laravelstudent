...
@section('content')
    ...
    <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form  action="{{url('/')}}/admin/scholarship/save" method="post" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text"  name="description" class="form-control" id="keyword" placeholder="description">
                </div>
            ...
            <!-- <div class="form-group">
                ...
                <div class="form-group">
                    <label >Details</label>
                    <input type="text" name="detail"  class="form-control" id="" placeholder="detail">
                </div>
